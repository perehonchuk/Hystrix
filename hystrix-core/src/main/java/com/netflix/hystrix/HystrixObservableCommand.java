...
public abstract class HystrixObservableCommand<R> extends AbstractCommand<R> implements HystrixObservable<R>, HystrixInvokableInfo<R> {
     ...
     * <p>
     * This method is called BEFORE the command's construct() method is executed, but AFTER the circuit breaker check.
     * If this method returns false, the command will skip execution and immediately invoke the resumeWithFallback method.
     * <p>
