...
public abstract class HystrixCollapser<BatchReturnType, ResponseType, RequestArgumentType> implements HystrixExecutable<ResponseType>, HystrixObservable<ResponseType> {
     ...
     * <p>
     * IMPORTANT: The order returned by this method affects:
     * <ul>
     * <li>The order in which requests appear in the Collection passed to {@link #createCommand}</li>
     * <li>The expected order when mapping responses in {@link #mapResponseToRequests}</li>
     * </ul>
     * <p>
