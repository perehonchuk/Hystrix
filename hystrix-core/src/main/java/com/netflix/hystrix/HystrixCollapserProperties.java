...
public abstract class HystrixCollapserProperties {
    ...
    private static final Boolean default_priorityBatchingEnabled = false;
    ...
    private final HystrixProperty<Boolean> priorityBatchingEnabled;
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.priorityBatchingEnabled = getProperty(propertyPrefix, key, "priorityBatching.enabled", builder.getPriorityBatchingEnabled(), default_priorityBatchingEnabled);
    ...
    /**
     * Whether priority-based batching is enabled. When enabled, requests with different priorities
     * will be batched separately, allowing high-priority requests to be processed independently
     * from low-priority requests.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> priorityBatchingEnabled() {
        return priorityBatchingEnabled;
    }
    ...
    public static class Setter {
        ...
        private Boolean priorityBatchingEnabled = null;
        ...
        public Boolean getPriorityBatchingEnabled() {
            return priorityBatchingEnabled;
        }
        ...
        public Setter withPriorityBatchingEnabled(boolean value) {
            this.priorityBatchingEnabled = value;
            return this;
        }
