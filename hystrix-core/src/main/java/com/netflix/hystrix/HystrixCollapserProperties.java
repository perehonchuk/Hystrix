...
public abstract class HystrixCollapserProperties {
    ...
    private static final Integer default_autoBatchSplitThreshold = 50;
    private static final Boolean default_autoBatchSplitEnabled = true;
    ...
    private final HystrixProperty<Integer> autoBatchSplitThreshold;
    private final HystrixProperty<Boolean> autoBatchSplitEnabled;
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.autoBatchSplitThreshold = getProperty(propertyPrefix, key, "autoBatchSplitThreshold", builder.getAutoBatchSplitThreshold(), default_autoBatchSplitThreshold);
        this.autoBatchSplitEnabled = getProperty(propertyPrefix, key, "autoBatchSplit.enabled", builder.getAutoBatchSplitEnabled(), default_autoBatchSplitEnabled);
    ...
    /**
     * The threshold at which automatic batch splitting will occur. When a batch exceeds this size,
     * it will be split into multiple sub-batches before user-defined sharding is applied.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> autoBatchSplitThreshold() {
        return autoBatchSplitThreshold;
    }

    /**
     * Whether automatic batch splitting is enabled. When true, large batches will be automatically
     * split into smaller sub-batches before being passed to user sharding logic.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> autoBatchSplitEnabled() {
        return autoBatchSplitEnabled;
    }
    ...
    public static class Setter {
        ...
        private Integer autoBatchSplitThreshold = null;
        private Boolean autoBatchSplitEnabled = null;
        ...
        public Integer getAutoBatchSplitThreshold() {
            return autoBatchSplitThreshold;
        }

        public Boolean getAutoBatchSplitEnabled() {
            return autoBatchSplitEnabled;
        }
        ...
        public Setter withAutoBatchSplitThreshold(int value) {
            this.autoBatchSplitThreshold = value;
            return this;
        }

        public Setter withAutoBatchSplitEnabled(boolean value) {
            this.autoBatchSplitEnabled = value;
            return this;
        }
