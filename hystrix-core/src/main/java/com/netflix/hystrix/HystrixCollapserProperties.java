...
public abstract class HystrixCollapserProperties {
    ...
    private static final Boolean default_batchRetryEnabled = true;
    private static final Integer default_batchRetryMaxAttempts = 2;
    ...
    private final HystrixProperty<Boolean> batchRetryEnabled;
    private final HystrixProperty<Integer> batchRetryMaxAttempts;
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.batchRetryEnabled = getProperty(propertyPrefix, key, "batchRetry.enabled", builder.getBatchRetryEnabled(), default_batchRetryEnabled);
        this.batchRetryMaxAttempts = getProperty(propertyPrefix, key, "batchRetry.maxAttempts", builder.getBatchRetryMaxAttempts(), default_batchRetryMaxAttempts);
    ...
    /**
     * Whether automatic batch retry is enabled. When enabled, if a batch command fails, the collapser
     * will automatically split the batch into smaller chunks and retry them.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> batchRetryEnabled() {
        return batchRetryEnabled;
    }

    /**
     * The maximum number of retry attempts for failed batches when batch retry is enabled.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> batchRetryMaxAttempts() {
        return batchRetryMaxAttempts;
    }
    ...
    public static class Setter {
        ...
        private Integer batchRetryMaxAttempts = null;
        ...
        public Boolean getBatchRetryEnabled() {
            return batchRetryEnabled;
        }

        public Integer getBatchRetryMaxAttempts() {
            return batchRetryMaxAttempts;
        }
        ...
        public Setter withBatchRetryEnabled(boolean value) {
            this.batchRetryEnabled = value;
            return this;
        }

        public Setter withBatchRetryMaxAttempts(int value) {
            this.batchRetryMaxAttempts = value;
            return this;
        }
