...
public abstract class HystrixCollapserProperties {
    ...
    private static final Boolean default_priorityBasedBatchingEnabled = false;
    ...
    private final HystrixProperty<Boolean> priorityBasedBatchingEnabled;
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.priorityBasedBatchingEnabled = getProperty(propertyPrefix, key, "priorityBasedBatching.enabled", builder.getPriorityBasedBatchingEnabled(), default_priorityBasedBatchingEnabled);
    ...
    /**
     * Whether priority-based batching is enabled for request collapsing.
     * When enabled, requests are grouped and executed in priority order (HIGH, NORMAL, LOW).
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> priorityBasedBatchingEnabled() {
        return priorityBasedBatchingEnabled;
    }
    ...
    public static class Setter {
        ...
        private Boolean priorityBasedBatchingEnabled = null;
        ...
        public Boolean getPriorityBasedBatchingEnabled() {
            return priorityBasedBatchingEnabled;
        }
        ...
        public Setter withPriorityBasedBatchingEnabled(boolean value) {
            this.priorityBasedBatchingEnabled = value;
            return this;
        }
