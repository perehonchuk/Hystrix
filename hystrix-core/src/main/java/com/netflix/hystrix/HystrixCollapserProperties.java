...
public abstract class HystrixCollapserProperties {
    ...
    private static final Integer default_batchSizeWarningThreshold = 100; // default warning threshold for batch size monitoring
    ...
    private final HystrixProperty<Integer> batchSizeWarningThreshold; // threshold for logging warnings about large batches
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.batchSizeWarningThreshold = getProperty(propertyPrefix, key, "batchSizeWarningThreshold", builder.getBatchSizeWarningThreshold(), default_batchSizeWarningThreshold);
    ...
    /**
     * The batch size threshold at which warnings will be logged about potentially inefficient batching.
     * This helps identify collapsers that may benefit from tuning their batch size or timer delay configuration.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> batchSizeWarningThreshold() {
        return batchSizeWarningThreshold;
    }
    ...
    public static class Setter {
        ...
        private Integer batchSizeWarningThreshold = null;
        ...
        public Integer getBatchSizeWarningThreshold() {
            return batchSizeWarningThreshold;
        }
        ...
        public Setter withBatchSizeWarningThreshold(int value) {
            this.batchSizeWarningThreshold = value;
            return this;
        }
