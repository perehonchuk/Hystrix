...
public abstract class HystrixCollapserProperties {
    ...
    private static final Integer default_autoShardBatchSize = 50; // default => auto-split batches larger than 50 requests
    ...
    private final HystrixProperty<Integer> autoShardBatchSize;
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.autoShardBatchSize = getProperty(propertyPrefix, key, "autoShardBatchSize", builder.getAutoShardBatchSize(), default_autoShardBatchSize);
    ...
    /**
     * The maximum batch size for automatic sharding. Batches larger than this will be automatically split
     * into multiple smaller batches before user sharding logic is applied.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> autoShardBatchSize() {
        return autoShardBatchSize;
    }
    ...
    public static class Setter {
        ...
        private Integer autoShardBatchSize = null;
        ...
        public Integer getAutoShardBatchSize() {
            return autoShardBatchSize;
        }
        ...
        public Setter withAutoShardBatchSize(int value) {
            this.autoShardBatchSize = value;
            return this;
        }
