...
public abstract class HystrixCollapserProperties {
    ...
    /**
     * The minimum number of requests required in a batch before allowing timer-based batch execution.
     * If the batch size is below this threshold when the timer fires, execution will be delayed.
     * This prevents inefficient execution of very small batches.
     *
     * @return {@code HystrixProperty<Integer>}
     */
