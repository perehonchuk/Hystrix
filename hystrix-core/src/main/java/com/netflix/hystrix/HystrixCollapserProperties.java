...
public abstract class HystrixCollapserProperties {
    ...
    private static final Boolean default_autoPartitioningEnabled = true;
    private static final Integer default_partitionSize = 50;
    ...
    private final HystrixProperty<Boolean> autoPartitioningEnabled;
    private final HystrixProperty<Integer> partitionSize;
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.autoPartitioningEnabled = getProperty(propertyPrefix, key, "autoPartitioning.enabled", builder.getAutoPartitioningEnabled(), default_autoPartitioningEnabled);
        this.partitionSize = getProperty(propertyPrefix, key, "autoPartitioning.partitionSize", builder.getPartitionSize(), default_partitionSize);
    ...
    /**
     * Whether automatic batch partitioning is enabled. When enabled, batches larger than partitionSize will be
     * automatically split into multiple sub-batches that execute in parallel.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> autoPartitioningEnabled() {
        return autoPartitioningEnabled;
    }

    /**
     * The maximum size of each partition when automatic batch partitioning is enabled.
     * Batches larger than this size will be split into multiple partitions.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> partitionSize() {
    ...
    public static class Setter {
        ...
        private Boolean autoPartitioningEnabled = null;
        ...
        public Boolean getAutoPartitioningEnabled() {
            return autoPartitioningEnabled;
        }
        ...
        public Setter withAutoPartitioningEnabled(boolean value) {
            this.autoPartitioningEnabled = value;
            return this;
        }

        public Setter withPartitionSize(int value) {
