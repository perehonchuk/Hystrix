...
public abstract class HystrixCollapserProperties {
    ...
    private static final Boolean default_sequentialShardExecution = true; // default to sequential execution for more predictable behavior
    ...
    private final HystrixProperty<Boolean> sequentialShardExecution; // whether to execute shards sequentially or in parallel
    ...
    protected HystrixCollapserProperties(HystrixCollapserKey key, Setter builder, String propertyPrefix) {
        ...
        this.sequentialShardExecution = getProperty(propertyPrefix, key, "sequentialShardExecution", builder.getSequentialShardExecution(), default_sequentialShardExecution);
    ...
    /**
     * Whether shards should be executed sequentially (true) or in parallel (false).
     * <p>
     * Sequential execution ensures that shards are processed one at a time in a predictable order,
     * which can be important for maintaining consistency when backend systems have ordering requirements
     * or when parallel execution might cause resource contention.
     * <p>
     * Default: true (sequential execution)
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> sequentialShardExecution() {
        return sequentialShardExecution;
    }
    ...
    public static class Setter {
        ...
        private Boolean sequentialShardExecution = null;
        ...
        public Boolean getSequentialShardExecution() {
            return sequentialShardExecution;
        }
        ...
        public Setter withSequentialShardExecution(boolean value) {
            this.sequentialShardExecution = value;
            return this;
        }
