...
public abstract class HystrixThreadPoolProperties {
    ...
    static int default_maximumSize = 20;         // maximum size of thread pool
    ...
    static boolean default_allow_maximum_size_to_diverge_from_core_size = true; //should the maximumSize config value get read and used in configuring the threadPool
                                                                                 //enabled by default to allow elastic thread pool sizing
