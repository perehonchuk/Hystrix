...
/* package */class CollapsedRequestSubject<T, R> implements CollapsedRequest<T, R> {
    ...
    private final com.netflix.hystrix.HystrixCollapser.Priority priority;
    ...
    public CollapsedRequestSubject(final R arg, final RequestBatch<?, T, R> containingBatch, com.netflix.hystrix.HystrixCollapser.Priority priority) {
    ...
    public CollapsedRequestSubject(final R arg, com.netflix.hystrix.HystrixCollapser.Priority priority) {
        this.subjectWithAccounting = subject;
        this.argument = arg;
        this.priority = priority;
    }
     ...
     */
    @Override
    public com.netflix.hystrix.HystrixCollapser.Priority getPriority() {
        return priority;
    }
