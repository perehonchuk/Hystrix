...
/* package */class CollapsedRequestSubject<T, R> implements CollapsedRequest<T, R> {
    ...
    public CollapsedRequestSubject(final R arg, final RequestBatch<?, T, R> containingBatch) {
        this(arg, containingBatch, Priority.NORMAL);
    }

    public CollapsedRequestSubject(final R arg, final RequestBatch<?, T, R> containingBatch, Priority priority) {
    ...
    public CollapsedRequestSubject(final R arg) {
        this(arg, Priority.NORMAL);
    }

    public CollapsedRequestSubject(final R arg, Priority priority) {
        this.subjectWithAccounting = subject;
        this.argument = arg;
        this.priority = priority;
    }
