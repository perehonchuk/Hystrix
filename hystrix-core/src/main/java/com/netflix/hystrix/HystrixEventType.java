...
public enum HystrixEventType {
    ...
    SECONDARY_FALLBACK_REJECTION(true),
    SECONDARY_FALLBACK_MISSING(true),
    TERTIARY_FALLBACK_EMIT(false),
    TERTIARY_FALLBACK_SUCCESS(true),
    TERTIARY_FALLBACK_FAILURE(true),
    TERTIARY_FALLBACK_REJECTION(true),
    TERTIARY_FALLBACK_MISSING(true),
    ...
    public static HystrixEventType from(HystrixRollingNumberEvent event) {
        switch (event) {
            ...
            case SECONDARY_FALLBACK_REJECTION: return SECONDARY_FALLBACK_REJECTION;
            case SECONDARY_FALLBACK_MISSING: return SECONDARY_FALLBACK_MISSING;
            case TERTIARY_FALLBACK_EMIT: return TERTIARY_FALLBACK_EMIT;
            case TERTIARY_FALLBACK_SUCCESS: return TERTIARY_FALLBACK_SUCCESS;
            case TERTIARY_FALLBACK_FAILURE: return TERTIARY_FALLBACK_FAILURE;
            case TERTIARY_FALLBACK_REJECTION: return TERTIARY_FALLBACK_REJECTION;
            case TERTIARY_FALLBACK_MISSING: return TERTIARY_FALLBACK_MISSING;
    ...
    static {
        ...
        EXCEPTION_PRODUCING_EVENT_TYPES.add(SECONDARY_FALLBACK_REJECTION);
        EXCEPTION_PRODUCING_EVENT_TYPES.add(SECONDARY_FALLBACK_MISSING);
        EXCEPTION_PRODUCING_EVENT_TYPES.add(TERTIARY_FALLBACK_FAILURE);
        EXCEPTION_PRODUCING_EVENT_TYPES.add(TERTIARY_FALLBACK_REJECTION);
        EXCEPTION_PRODUCING_EVENT_TYPES.add(TERTIARY_FALLBACK_MISSING);
