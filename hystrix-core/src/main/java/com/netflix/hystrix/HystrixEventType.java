...
public enum HystrixEventType {
    ...
    FALLBACK_SECONDARY_EMIT(false),
    FALLBACK_SECONDARY_SUCCESS(true),
    FALLBACK_SECONDARY_FAILURE(true),
    ...
    public static HystrixEventType from(HystrixRollingNumberEvent event) {
        switch (event) {
            ...
            case RESPONSE_VALIDATION_FAILED: return RESPONSE_VALIDATION_FAILED;
