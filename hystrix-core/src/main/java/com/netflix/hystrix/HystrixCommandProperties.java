...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_circuitBreakerRecoveryAttempts = 3;// default => recoveryAttempts: 3 = number of concurrent requests to allow in HALF_OPEN state
    ...
    private final HystrixProperty<Integer> circuitBreakerRecoveryAttempts; // number of concurrent requests to allow in HALF_OPEN state for batch recovery
    ...
    protected HystrixCommandProperties(HystrixCommandKey key, HystrixCommandProperties.Setter builder, String propertyPrefix) {
        ...
        this.circuitBreakerRecoveryAttempts = getProperty(propertyPrefix, key, "circuitBreaker.recoveryAttempts", builder.getCircuitBreakerRecoveryAttempts(), default_circuitBreakerRecoveryAttempts);
    ...
    /**
     * Number of concurrent requests to allow in HALF_OPEN state for batch recovery testing.
     * <p>
     * All recovery attempts must succeed for the circuit to close. If any fail, the circuit reopens.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> circuitBreakerRecoveryAttempts() {
        return circuitBreakerRecoveryAttempts;
    }
    ...
    public static class Setter {
        ...
        private Integer circuitBreakerRecoveryAttempts = null;
        ...
        public Integer getCircuitBreakerRecoveryAttempts() {
            return circuitBreakerRecoveryAttempts;
        }
        ...
        public Setter withCircuitBreakerRecoveryAttempts(int value) {
            this.circuitBreakerRecoveryAttempts = value;
            return this;
        }
