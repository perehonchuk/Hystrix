...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_retryEnabled = true; // default => retry enabled for transient failures
    private static final Integer default_retryMaxAttempts = 2; // default => retry up to 2 times (3 total attempts including initial)
    private static final Integer default_retryDelayInMilliseconds = 100; // default => 100ms delay between retry attempts
    ...
    private final HystrixProperty<Boolean> retryEnabled; // Whether automatic retries are enabled for transient failures.
    ...
    /**
     * Whether automatic retry on transient failures is enabled.
     * When enabled, failed executions will be retried automatically before falling back.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
