...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_requestCacheInvalidateOnFallback = true; // default to automatically invalidate cache when fallback is executed
    ...
    private final HystrixProperty<Boolean> requestCacheInvalidateOnFallback; // Whether request cache should be automatically invalidated when fallback is executed
    ...
    protected HystrixCommandProperties(HystrixCommandKey key, HystrixCommandProperties.Setter builder, String propertyPrefix) {
        ...
        this.requestCacheInvalidateOnFallback = getProperty(propertyPrefix, key, "requestCache.invalidateOnFallback", builder.getRequestCacheInvalidateOnFallback(), default_requestCacheInvalidateOnFallback);
    ...
    /**
     * Whether the request cache should be automatically invalidated when fallback is executed.
     * When true, executing fallback will clear the cached result for the current request's cache key,
     * forcing subsequent requests within the same HystrixRequestContext to re-execute instead of
     * returning the previously cached value. This is useful when fallback values should not be cached
     * or when failed executions should not poison the cache for subsequent requests in the same context.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> requestCacheInvalidateOnFallback() {
        return requestCacheInvalidateOnFallback;
    }
    ...
    public static class Setter {
        ...
        private Boolean requestCacheInvalidateOnFallback = null;
        ...
        public Boolean getRequestCacheInvalidateOnFallback() {
            return requestCacheInvalidateOnFallback;
        }
        ...
        public Setter withRequestCacheInvalidateOnFallback(boolean value) {
            this.requestCacheInvalidateOnFallback = value;
            return this;
        }
    }
}
