...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_retryEnabled = false; // default => retryEnabled: false = retries disabled by default
    private static final Integer default_retryMaxAttempts = 2; // default => retryMaxAttempts: 2 = up to 2 retry attempts (3 total executions including initial)
    private static final Integer default_retryDelayInMilliseconds = 100; // default => retryDelayInMilliseconds: 100ms delay between retries
    ...
    private final HystrixProperty<Boolean> retryEnabled; // Whether automatic retry is enabled on failures.
     ...
     * When enabled, failed executions will be retried up to retryMaxAttempts times before invoking fallback.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    ...
    /**
     * Maximum number of retry attempts for failed command executions.
     * This represents the number of additional attempts after the initial execution.
     * For example, retryMaxAttempts=2 means 3 total executions (1 initial + 2 retries).
     *
     * @return {@code HystrixProperty<Integer>}
     */
     ...
     * This provides a simple backoff mechanism to avoid overwhelming the downstream service.
     *
     * @return {@code HystrixProperty<Integer>}
     */
