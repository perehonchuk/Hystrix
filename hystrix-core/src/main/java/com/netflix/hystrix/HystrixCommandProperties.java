...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_circuitBreakerHalfOpenRequestLimit = 1;// default => halfOpenRequestLimit: 1 = only one request during half-open state 
    ...
    private final HystrixProperty<Integer> circuitBreakerHalfOpenRequestLimit; // number of concurrent requests permitted during half-open state
    ...
    /**
     * Maximum number of concurrent requests permitted during the HALF_OPEN state.
     * <p>
     * When the circuit is HALF_OPEN, this controls how many requests can be attempted concurrently.
     * If this limit is exceeded, additional requests will be rejected until in-flight half-open requests complete.
     * <p>
     * A value of 1 provides traditional circuit breaker behavior (single test request).
     * Higher values enable gradual recovery under load.
     *
     * @return {@code HystrixProperty<Integer>}
     */
