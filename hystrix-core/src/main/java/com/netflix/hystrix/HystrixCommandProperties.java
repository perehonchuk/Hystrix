...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_retryEnabled = false; // default to retry disabled for backward compatibility
    private static final Integer default_retryMaxAttempts = 2; // default to 2 retry attempts (total 3 executions including original)
    ...
    private final HystrixProperty<Boolean> retryEnabled; // Whether automatic retry on failure is enabled.
    private final HystrixProperty<Integer> retryMaxAttempts; // Maximum number of retry attempts (not including original execution).
    ...
    /**
     * Whether automatic retry on failure is enabled for {@link HystrixCommand} execution.
     * When enabled, failed executions will be retried up to the maximum number of attempts
     * specified by {@link #retryMaxAttempts()}.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    ...
    /**
     * Maximum number of retry attempts for a {@link HystrixCommand} execution.
     * This does not include the original execution attempt. For example, if set to 2,
     * the command will be executed a maximum of 3 times total (1 original + 2 retries).
     *
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Delay in milliseconds between retry attempts for a {@link HystrixCommand} execution.
     * The command will wait this duration before attempting a retry after a failed execution.
     *
     * @return {@code HystrixProperty<Integer>}
     */
