...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_requestCacheTtlInMilliseconds = -1; // default to -1 (no TTL, cache never expires)
    ...
    private final HystrixProperty<Integer> requestCacheTtlInMilliseconds; // TTL for cached responses in milliseconds (-1 means no expiration)
    ...
    /**
     * Time-to-live in milliseconds for cached responses in {@link HystrixRequestCache}.
     * Entries older than this TTL will be automatically evicted from the cache.
     * A value of -1 means cached entries never expire.
     *
     * @return {@code HystrixProperty<Integer>}
     */
