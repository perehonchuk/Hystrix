...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_circuitBreakerHalfOpenSuccessThreshold = 3;// default => halfOpenSuccessThreshold = 3 = number of successful executions required in HALF_OPEN state before closing circuit
    ...
    private final HystrixProperty<Integer> circuitBreakerHalfOpenSuccessThreshold; // number of consecutive successful executions required in HALF_OPEN state before closing the circuit
    ...
    /**
     * Number of consecutive successful executions required in HALF_OPEN state before closing the circuit.
     * <p>
     * When the circuit breaker is in HALF_OPEN state after the sleep window has elapsed, it will allow requests through
     * and track consecutive successes. Once this threshold is reached, the circuit transitions from HALF_OPEN to CLOSED.
     * Any failure in HALF_OPEN state will immediately transition the circuit back to OPEN.
     *
     * @return {@code HystrixProperty<Integer>}
     */
