...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_requestCacheTTLInMilliseconds = 60000; // default to 60 seconds (60000ms) TTL for cached values
    private static final Boolean default_requestCacheTTLEnabled = false; // default to disabled for backward compatibility
    ...
    /**
     * Time-to-live (TTL) in milliseconds for cached values in the request cache.
     * Only applies when requestCacheTTLEnabled() is true.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Whether TTL-based cache expiration is enabled for request caching.
     * When enabled, cached values will expire after the duration specified by requestCacheTTLInMilliseconds().
     *
     * @return {@code HystrixProperty<Boolean>}
     */
