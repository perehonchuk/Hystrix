...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_retryEnabled = false; // default => retryEnabled: false (retry is disabled by default)
    private static final Integer default_retryMaxAttempts = 2; // default => maxRetryAttempts: 2 (will retry up to 2 times if enabled)
    private static final Integer default_retryDelayInMilliseconds = 100; // default => retryDelay: 100ms between retry attempts
    ...
    /**
     * Whether automatic retry should be attempted on command execution failures.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
