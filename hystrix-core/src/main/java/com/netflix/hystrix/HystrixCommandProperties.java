...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_executionRetryEnabled = true; // default to enabled automatic retry
    private static final Integer default_executionRetryMaxAttempts = 2; // default to 2 retry attempts before falling back
    ...
    private final HystrixProperty<Boolean> executionRetryEnabled; // Whether automatic retry is enabled before falling back
    private final HystrixProperty<Integer> executionRetryMaxAttempts; // Maximum number of retry attempts before falling back
    ...
    /**
     * Whether automatic retry of failed executions is enabled before falling back.
     * When enabled, a command will retry execution upon failure before invoking the fallback.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    ...
    /**
     * Maximum number of retry attempts for failed executions before falling back.
     * Only applies when {@link #executionRetryEnabled()} is true.
     *
     * @return {@code HystrixProperty<Integer>}
     */
