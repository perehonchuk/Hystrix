...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_requestCacheMaxSize = 1000; // default to 1000 entries max in request cache before LRU eviction
    ...
    private final HystrixProperty<Integer> requestCacheMaxSize; // Maximum number of entries in request cache before LRU eviction
    ...
    protected HystrixCommandProperties(HystrixCommandKey key, HystrixCommandProperties.Setter builder, String propertyPrefix) {
        ...
        this.requestCacheMaxSize = getProperty(propertyPrefix, key, "requestCache.maxSize", builder.getRequestCacheMaxSize(), default_requestCacheMaxSize);
    ...
    /**
     * Maximum number of entries allowed in the {@link HystrixRequestCache} before LRU eviction occurs.
     * <p>
     * When the cache size exceeds this threshold, the least recently used entries will be evicted to maintain the limit.
     * <p>
     * Default value is 1000 entries.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> requestCacheMaxSize() {
        return requestCacheMaxSize;
    }
    ...
    public static class Setter {
        ...
        private Integer requestCacheMaxSize = null;
        ...
        public Integer getRequestCacheMaxSize() {
            return requestCacheMaxSize;
        }
        ...
        public Setter withRequestCacheMaxSize(int value) {
            this.requestCacheMaxSize = value;
            return this;
        }
