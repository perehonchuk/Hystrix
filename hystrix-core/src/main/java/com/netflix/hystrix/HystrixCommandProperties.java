...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_retryEnabled = true; // default => retry is enabled before fallback
    private static final Integer default_retryMaxAttempts = 2; // default => retry up to 2 times before fallback
    private static final Integer default_retryDelayInMilliseconds = 100; // default => 100ms delay between retries
    ...
    private final HystrixProperty<Boolean> retryEnabled; // Whether retries should be attempted before fallback.
    private final HystrixProperty<Integer> retryMaxAttempts; // Maximum number of retry attempts before falling back.
    ...
    /**
     * Whether retry should be attempted before falling back.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
