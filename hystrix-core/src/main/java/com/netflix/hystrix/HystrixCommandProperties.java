...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_circuitBreakerHalfOpenConcurrentRequests = 3; // default => halfOpenConcurrentRequests: 3 concurrent requests allowed during half-open state
    ...
    private final HystrixProperty<Integer> circuitBreakerHalfOpenConcurrentRequests; // number of concurrent requests allowed in half-open state
    ...
    protected HystrixCommandProperties(HystrixCommandKey key, HystrixCommandProperties.Setter builder, String propertyPrefix) {
        ...
        this.circuitBreakerHalfOpenConcurrentRequests = getProperty(propertyPrefix, key, "circuitBreaker.halfOpenConcurrentRequests", builder.getCircuitBreakerHalfOpenConcurrentRequests(), default_circuitBreakerHalfOpenConcurrentRequests);
    ...
    /**
     * Number of concurrent requests allowed during the HALF_OPEN state of a circuit breaker.
     * This allows multiple test requests to be executed concurrently to assess service health.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> circuitBreakerHalfOpenConcurrentRequests() {
        return circuitBreakerHalfOpenConcurrentRequests;
    }
    ...
    public static class Setter {
        ...
        private Integer circuitBreakerHalfOpenConcurrentRequests = null;
        ...
        public Integer getCircuitBreakerHalfOpenConcurrentRequests() {
            return circuitBreakerHalfOpenConcurrentRequests;
        }
        ...
        public Setter withCircuitBreakerHalfOpenConcurrentRequests(int value) {
            this.circuitBreakerHalfOpenConcurrentRequests = value;
            return this;
        }
