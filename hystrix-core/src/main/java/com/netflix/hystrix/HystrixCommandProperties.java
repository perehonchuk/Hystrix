...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_fallbackPriority = false; // default => fallbackPriority: false = execute main command first, fallback only on failure
    ...
    private final HystrixProperty<Boolean> fallbackPriority; // Whether fallback should be executed first before main command
    ...
    protected HystrixCommandProperties(HystrixCommandKey key, HystrixCommandProperties.Setter builder, String propertyPrefix) {
        ...
        this.fallbackPriority = getProperty(propertyPrefix, key, "fallback.priority", builder.getFallbackPriority(), default_fallbackPriority);
    ...
    /**
     * Whether fallback should be executed with priority (before main command execution).
     * When enabled, the fallback method is executed first, and if it succeeds, the main command is not executed at all.
     * This is useful for gradual migration scenarios, testing fallback logic, or progressive deployment patterns.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> fallbackPriority() {
    ...
    public static class Setter {
        ...
        private Boolean fallbackPriority = null;
        ...
        public Boolean getFallbackPriority() {
            return fallbackPriority;
        }
        ...
        public Setter withFallbackPriority(boolean value) {
            this.fallbackPriority = value;
            return this;
        }
