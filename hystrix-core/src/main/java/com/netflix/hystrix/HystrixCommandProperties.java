...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_retryEnabled = true; // default => retryEnabled = true (automatic retry is enabled)
    private static final Integer default_retryMaxAttempts = 2; // default => retryMaxAttempts: 2 = maximum 2 retry attempts after initial failure
    private static final Integer default_retryDelayInMilliseconds = 100; // default => retryDelayInMilliseconds: 100 = 100ms delay between retry attempts
    ...
    /**
     * Whether automatic retry on execution failures is enabled.
     * When enabled, failed command executions will be automatically retried up to the configured maximum attempts.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    ...
    /**
     * Maximum number of retry attempts after an initial execution failure.
     ...
     * This introduces a backoff period before retrying a failed execution.
     *
     * @return {@code HystrixProperty<Integer>}
     */
