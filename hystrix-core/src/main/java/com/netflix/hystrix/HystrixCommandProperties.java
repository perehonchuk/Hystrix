...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_warmupEnabled = true; // default to enabling warmup phase
    private static final Integer default_warmupTimeoutInMilliseconds = 500; // default warmup timeout of 500ms
    ...
    private final HystrixProperty<Boolean> warmupEnabled; // Whether warmup phase is enabled
    private final HystrixProperty<Integer> warmupTimeoutInMilliseconds; // Timeout for warmup execution
    ...
    protected HystrixCommandProperties(HystrixCommandKey key, HystrixCommandProperties.Setter builder, String propertyPrefix) {
        ...
        this.warmupEnabled = getProperty(propertyPrefix, key, "warmup.enabled", builder.getWarmupEnabled(), default_warmupEnabled);
        this.warmupTimeoutInMilliseconds = getProperty(propertyPrefix, key, "warmup.timeoutInMilliseconds", builder.getWarmupTimeoutInMilliseconds(), default_warmupTimeoutInMilliseconds);
    ...
    /**
     * Whether warmup phase should be executed before command run.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
    public HystrixProperty<Boolean> warmupEnabled() {
        return warmupEnabled;
    }

    /**
     * Timeout value in milliseconds for warmup execution.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> warmupTimeoutInMilliseconds() {
        return warmupTimeoutInMilliseconds;
    }
    ...
    public static class Setter {
        ...
        private Boolean warmupEnabled = null;
        private Integer warmupTimeoutInMilliseconds = null;
        ...
        public Integer getWarmupTimeoutInMilliseconds() {
            return warmupTimeoutInMilliseconds;
        }
        ...
        public Setter withWarmupEnabled(boolean value) {
            this.warmupEnabled = value;
            return this;
        }

        public Setter withWarmupTimeoutInMilliseconds(int value) {
            this.warmupTimeoutInMilliseconds = value;
            return this;
        }
    }
}
