...
public abstract class HystrixCommandProperties {
    ...
    private static final Boolean default_retryEnabled = true; // default => retryEnabled = true (retry on failures)
    private static final Integer default_retryMaxAttempts = 2; // default => retryMaxAttempts: 2 = retry up to 2 times (3 total attempts including original)
    private static final Integer default_retryDelayInMilliseconds = 100; // default => retryDelay: 100ms = wait 100ms between retry attempts
