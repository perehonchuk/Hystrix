...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_retryMaxAttempts = 2; // default => retry up to 2 times (total 3 attempts including initial)
    private static final Integer default_retryDelayInMilliseconds = 100; // default => wait 100ms between retries
    ...
    /**
     * Whether automatic retry is enabled for failed commands.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
