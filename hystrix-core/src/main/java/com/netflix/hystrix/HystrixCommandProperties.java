...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_retryMaxAttempts = 2; // default to 2 retry attempts (3 total executions including initial)
    private static final Integer default_retryDelayInMilliseconds = 100; // default to 100ms delay between retry attempts
    ...
    private final HystrixProperty<Boolean> retryEnabled; // Whether retry on failure is enabled.
    ...
    /**
     * Whether retry on failure is enabled for the command.
     * When enabled, failed command executions will be retried up to retryMaxAttempts times
     * with a delay of retryDelayInMilliseconds between attempts.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
     ...
     * For example, if set to 2, the command will execute a maximum of 3 times total
     * (1 initial + 2 retries).
     *
     * @return {@code HystrixProperty<Integer>}
     */
     ...
     * This provides a backoff period before retrying a failed execution.
     *
     * @return {@code HystrixProperty<Integer>}
     */
