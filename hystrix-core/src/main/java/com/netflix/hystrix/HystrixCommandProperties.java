...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_circuitBreakerRequestVolumeThreshold = 10;// default => statisticalWindowVolumeThreshold: 10 requests in 10 seconds must occur before statistics matter
    private static final Integer default_circuitBreakerSleepWindowInMilliseconds = 3000;// default => sleepWindow: 3000 = 3 seconds that we will sleep before trying again after tripping the circuit
    private static final Integer default_circuitBreakerErrorThresholdPercentage = 30;// default => errorThresholdPercentage = 30 = if 30%+ of requests in 10 seconds are failures or latent then we will trip the circuit
