...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_executionPriority = 0; // default priority level for command execution (0 = normal priority)
    ...
    private final HystrixProperty<Integer> executionPriority; // Priority level for command execution (higher values = higher priority)
    ...
    protected HystrixCommandProperties(HystrixCommandKey key, HystrixCommandProperties.Setter builder, String propertyPrefix) {
        ...
        this.executionPriority = getProperty(propertyPrefix, key, "execution.priority", builder.getExecutionPriority(), default_executionPriority);
    ...
    /**
     * Priority level for command execution when thread pool priority queuing is enabled.
     * Higher values indicate higher priority. Commands with higher priority will be dequeued first.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    public HystrixProperty<Integer> executionPriority() {
    ...
    public static class Setter {
        ...
        private Integer executionPriority = null;
        ...
        public Setter withExecutionPriority(int value) {
