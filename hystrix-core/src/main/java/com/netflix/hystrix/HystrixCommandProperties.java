...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_requestCacheTTLInMilliseconds = 5000; // default => cacheTTL: 5000 = 5 seconds time-to-live for cached entries
    private static final Boolean default_requestCacheTTLEnabled = true; // default => cacheTTL enabled
    ...
    private final HystrixProperty<Integer> requestCacheTTLInMilliseconds; // Time-to-live for cached entries in milliseconds.
    private final HystrixProperty<Boolean> requestCacheTTLEnabled; // Whether time-based cache expiration is enabled.
    ...
    /**
     * Time-to-live for request cache entries in milliseconds. Cached entries older than this TTL will be considered expired.
     *
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Whether time-based expiration is enabled for request cache entries.
     *
     * @return {@code HystrixProperty<Boolean>}
     */
