...
public abstract class HystrixCommandProperties {
    ...
    private static final Integer default_circuitBreakerRecoverySuccessThreshold = 3;// default => recoverySuccessThreshold: 3 successful requests required to close circuit from RECOVERING state 
    ...
    private final HystrixProperty<Integer> circuitBreakerRecoverySuccessThreshold; // number of successful requests required in RECOVERING state before transitioning to CLOSED
    ...
    /**
     * Number of successful requests required in the RECOVERING state before the circuit transitions to CLOSED.
     * <p>
     * After the sleep window elapses and the circuit enters HALF_OPEN state, the first successful request
     * transitions the circuit to RECOVERING state. The circuit then requires this many successful requests
     * before fully closing. Any failure during RECOVERING will reopen the circuit.
     * <p>
     * Default value is 3.
     *
     * @return {@code HystrixProperty<Integer>}
