...
public enum HystrixRollingNumberEvent {
    ...
    CIRCUIT_BREAKER_OPENED(1), CIRCUIT_BREAKER_HALF_OPENED(1), CIRCUIT_BREAKER_CLOSED(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case CIRCUIT_BREAKER_OPENED: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_OPENED;
            case CIRCUIT_BREAKER_HALF_OPENED: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_HALF_OPENED;
            case CIRCUIT_BREAKER_CLOSED: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_CLOSED;
