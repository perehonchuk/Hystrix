...
public enum HystrixRollingNumberEvent {
    ...
    CIRCUIT_BREAKER_RECOVERING_SUCCESS(1), CIRCUIT_BREAKER_RECOVERING_FAILURE(1), CIRCUIT_BREAKER_RECOVERED(1), CIRCUIT_BREAKER_RECOVERY_FAILED(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case CIRCUIT_BREAKER_RECOVERING_SUCCESS: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_RECOVERING_SUCCESS;
            case CIRCUIT_BREAKER_RECOVERING_FAILURE: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_RECOVERING_FAILURE;
            case CIRCUIT_BREAKER_RECOVERED: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_RECOVERED;
            case CIRCUIT_BREAKER_RECOVERY_FAILED: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_RECOVERY_FAILED;
