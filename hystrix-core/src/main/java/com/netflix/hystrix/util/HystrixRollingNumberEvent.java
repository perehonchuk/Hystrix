...
public enum HystrixRollingNumberEvent {
    SUCCESS(1), FAILURE(1), TIMEOUT(1), SHORT_CIRCUITED(1), THREAD_POOL_REJECTED(1), QUEUE_REJECTION_SEMAPHORE_EXECUTION(1), SEMAPHORE_REJECTED(1), BAD_REQUEST(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case QUEUE_REJECTION_SEMAPHORE_EXECUTION: return HystrixRollingNumberEvent.QUEUE_REJECTION_SEMAPHORE_EXECUTION;
