...
public enum HystrixRollingNumberEvent {
    ...
    EXECUTION_SEMAPHORE_ACQUIRED(1), FALLBACK_SEMAPHORE_ACQUIRED(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case EXECUTION_SEMAPHORE_ACQUIRED: return HystrixRollingNumberEvent.EXECUTION_SEMAPHORE_ACQUIRED;
            case FALLBACK_SEMAPHORE_ACQUIRED: return HystrixRollingNumberEvent.FALLBACK_SEMAPHORE_ACQUIRED;
