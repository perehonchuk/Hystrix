...
public enum HystrixRollingNumberEvent {
    ...
    COLLAPSER_REQUEST_BATCHED(1), COLLAPSER_BATCH(1), QUEUED(1), QUEUE_TIMEOUT(1), DEDUPLICATED(1), QUEUE_MAX_ACTIVE(2);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case QUEUED: return HystrixRollingNumberEvent.QUEUED;
            case QUEUE_TIMEOUT: return HystrixRollingNumberEvent.QUEUE_TIMEOUT;
            case DEDUPLICATED: return HystrixRollingNumberEvent.DEDUPLICATED;
