...
public enum HystrixRollingNumberEvent {
    ...
    THREAD_EXECUTION(1), THREAD_MAX_ACTIVE(2), COLLAPSED(1), RESPONSE_FROM_CACHE(1), CACHE_EXPIRED(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case CACHE_EXPIRED: return HystrixRollingNumberEvent.CACHE_EXPIRED;
