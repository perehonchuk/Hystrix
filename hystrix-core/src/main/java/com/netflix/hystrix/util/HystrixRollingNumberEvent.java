...
public enum HystrixRollingNumberEvent {
    ...
    THREAD_EXECUTION(1), THREAD_MAX_ACTIVE(2), COLLAPSED(1), RESPONSE_FROM_CACHE(1), CACHE_EVICTED(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case CACHE_EVICTED: return HystrixRollingNumberEvent.CACHE_EVICTED;
