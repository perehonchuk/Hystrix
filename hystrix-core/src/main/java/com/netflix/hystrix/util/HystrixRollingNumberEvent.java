...
public enum HystrixRollingNumberEvent {
    ...
    COLLAPSER_REQUEST_BATCHED(1), COLLAPSER_BATCH(1), VALIDATION_STARTED(1), VALIDATION_SUCCESS(1), VALIDATION_FAILED(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case VALIDATION_STARTED: return HystrixRollingNumberEvent.VALIDATION_STARTED;
            case VALIDATION_SUCCESS: return HystrixRollingNumberEvent.VALIDATION_SUCCESS;
            case VALIDATION_FAILED: return HystrixRollingNumberEvent.VALIDATION_FAILED;
