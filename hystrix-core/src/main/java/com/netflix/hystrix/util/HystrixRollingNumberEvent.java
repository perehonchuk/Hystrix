...
public enum HystrixRollingNumberEvent {
    ...
    COLLAPSER_REQUEST_BATCHED(1), COLLAPSER_BATCH(1), RETRY_ATTEMPT(1), RETRY_SUCCESS(1), RETRY_EXHAUSTED(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case RETRY_ATTEMPT: return HystrixRollingNumberEvent.RETRY_ATTEMPT;
