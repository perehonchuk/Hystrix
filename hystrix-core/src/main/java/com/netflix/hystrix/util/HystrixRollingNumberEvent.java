...
public enum HystrixRollingNumberEvent {
    SUCCESS(1), FAILURE(1), TIMEOUT(1), SHORT_CIRCUITED(1), CIRCUIT_BREAKER_RECOVERING(1), THREAD_POOL_REJECTED(1), SEMAPHORE_REJECTED(1), BAD_REQUEST(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case CIRCUIT_BREAKER_RECOVERING: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_RECOVERING;
