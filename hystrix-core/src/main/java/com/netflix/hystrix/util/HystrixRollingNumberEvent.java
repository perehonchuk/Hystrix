...
public enum HystrixRollingNumberEvent {
    ...
    FALLBACK_SUCCESS(1), FALLBACK_FAILURE(1), FALLBACK_REJECTION(1), FALLBACK_DISABLED(1), FALLBACK_MISSING(1),
    SECONDARY_FALLBACK_SUCCESS(1), SECONDARY_FALLBACK_FAILURE(1), SECONDARY_FALLBACK_REJECTION(1), SECONDARY_FALLBACK_MISSING(1),
    TERTIARY_FALLBACK_SUCCESS(1), TERTIARY_FALLBACK_FAILURE(1), TERTIARY_FALLBACK_REJECTION(1), TERTIARY_FALLBACK_MISSING(1),
    EXCEPTION_THROWN(1), COMMAND_MAX_ACTIVE(2), EMIT(1), FALLBACK_EMIT(1), SECONDARY_FALLBACK_EMIT(1), TERTIARY_FALLBACK_EMIT(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case SECONDARY_FALLBACK_EMIT: return HystrixRollingNumberEvent.SECONDARY_FALLBACK_EMIT;
            case SECONDARY_FALLBACK_FAILURE: return HystrixRollingNumberEvent.SECONDARY_FALLBACK_FAILURE;
            case SECONDARY_FALLBACK_MISSING: return HystrixRollingNumberEvent.SECONDARY_FALLBACK_MISSING;
            case SECONDARY_FALLBACK_REJECTION: return HystrixRollingNumberEvent.SECONDARY_FALLBACK_REJECTION;
            case SECONDARY_FALLBACK_SUCCESS: return HystrixRollingNumberEvent.SECONDARY_FALLBACK_SUCCESS;
            case TERTIARY_FALLBACK_EMIT: return HystrixRollingNumberEvent.TERTIARY_FALLBACK_EMIT;
            case TERTIARY_FALLBACK_FAILURE: return HystrixRollingNumberEvent.TERTIARY_FALLBACK_FAILURE;
            case TERTIARY_FALLBACK_MISSING: return HystrixRollingNumberEvent.TERTIARY_FALLBACK_MISSING;
            case TERTIARY_FALLBACK_REJECTION: return HystrixRollingNumberEvent.TERTIARY_FALLBACK_REJECTION;
            case TERTIARY_FALLBACK_SUCCESS: return HystrixRollingNumberEvent.TERTIARY_FALLBACK_SUCCESS;
