...
public enum HystrixRollingNumberEvent {
    ...
    FALLBACK_RETRY_ATTEMPTED(1), FALLBACK_RETRY_SUCCESS(1), FALLBACK_RETRY_FAILURE(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case FALLBACK_RETRY_ATTEMPTED: return HystrixRollingNumberEvent.FALLBACK_RETRY_ATTEMPTED;
            case FALLBACK_RETRY_SUCCESS: return HystrixRollingNumberEvent.FALLBACK_RETRY_SUCCESS;
            case FALLBACK_RETRY_FAILURE: return HystrixRollingNumberEvent.FALLBACK_RETRY_FAILURE;
