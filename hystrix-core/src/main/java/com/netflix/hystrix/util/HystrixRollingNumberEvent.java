...
public enum HystrixRollingNumberEvent {
    ...
    COLLAPSER_REQUEST_BATCHED(1), COLLAPSER_BATCH(1), DUPLICATE_COMMAND_EXECUTION(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case DUPLICATE_COMMAND_EXECUTION: return HystrixRollingNumberEvent.DUPLICATE_COMMAND_EXECUTION;
