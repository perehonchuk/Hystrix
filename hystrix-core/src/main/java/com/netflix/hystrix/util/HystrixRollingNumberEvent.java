...
public enum HystrixRollingNumberEvent {
    ...
    FALLBACK_SUCCESS(1), FALLBACK_FAILURE(1), FALLBACK_REJECTION(1), FALLBACK_DISABLED(1), FALLBACK_MISSING(1), SECONDARY_FALLBACK_SUCCESS(1), SECONDARY_FALLBACK_FAILURE(1), EXCEPTION_THROWN(1), COMMAND_MAX_ACTIVE(2), EMIT(1), FALLBACK_EMIT(1),
