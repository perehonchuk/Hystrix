...
public enum HystrixRollingNumberEvent {
    ...
    COLLAPSER_REQUEST_BATCHED(1), COLLAPSER_BATCH(1), CIRCUIT_BREAKER_FORCED_HALF_OPEN(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case CIRCUIT_BREAKER_FORCED_HALF_OPEN: return HystrixRollingNumberEvent.CIRCUIT_BREAKER_FORCED_HALF_OPEN;
