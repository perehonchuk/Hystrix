...
public enum HystrixRollingNumberEvent {
    ...
    THREAD_EXECUTION(1), THREAD_MAX_ACTIVE(2), COLLAPSED(1), RESPONSE_FROM_CACHE(1), RESPONSE_VALIDATION_FAILED(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case RESPONSE_VALIDATION_FAILED: return HystrixRollingNumberEvent.RESPONSE_VALIDATION_FAILED;
