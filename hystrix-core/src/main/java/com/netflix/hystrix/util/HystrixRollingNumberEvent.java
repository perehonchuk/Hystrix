...
public enum HystrixRollingNumberEvent {
    SUCCESS(1), FAILURE(1), TIMEOUT_EXECUTION(1), TIMEOUT_FALLBACK(1), SHORT_CIRCUITED(1), THREAD_POOL_REJECTED(1), SEMAPHORE_REJECTED(1), BAD_REQUEST(1),
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case TIMEOUT_EXECUTION: return HystrixRollingNumberEvent.TIMEOUT_EXECUTION;
            case TIMEOUT_FALLBACK: return HystrixRollingNumberEvent.TIMEOUT_FALLBACK;
