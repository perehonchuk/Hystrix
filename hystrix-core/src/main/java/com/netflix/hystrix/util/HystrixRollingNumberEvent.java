...
public enum HystrixRollingNumberEvent {
    ...
    COLLAPSER_REQUEST_BATCHED(1), COLLAPSER_BATCH(1), THREAD_POOL_QUEUED(1), QUEUE_REMOVED(1);
    ...
    public static HystrixRollingNumberEvent from(HystrixEventType eventType) {
        switch (eventType) {
            ...
            case THREAD_POOL_QUEUED: return HystrixRollingNumberEvent.THREAD_POOL_QUEUED;
            case QUEUE_REMOVED: return HystrixRollingNumberEvent.QUEUE_REMOVED;
